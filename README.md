...
1. 🚀 Published release [v1.0.0](https://github.com/CodeWithSushil/svg-generator/releases/tag/v1.0.0) in [CodeWithSushil/svg-generator](https://github.com/CodeWithSushil/svg-generator)
2. 🚀 Published release [v0.0.0](https://github.com/CodeWithSushil/svg-generator/releases/tag/v0.0.0) in [CodeWithSushil/svg-generator](https://github.com/CodeWithSushil/svg-generator)
3. 🚀 Published release [v0.0.3](https://github.com/CodeWithSushil/xenophp/releases/tag/v0.0.3) in [CodeWithSushil/xenophp](https://github.com/CodeWithSushil/xenophp)
4. 💪 Opened PR [#79](https://github.com/Ashishkumbhar01/supabase-php/pull/79) in [Ashishkumbhar01/supabase-php](https://github.com/Ashishkumbhar01/supabase-php)
5. 🎉 Merged PR [#78](https://github.com/Ashishkumbhar01/supabase-php/pull/78) in [Ashishkumbhar01/supabase-php](https://github.com/Ashishkumbhar01/supabase-php)
